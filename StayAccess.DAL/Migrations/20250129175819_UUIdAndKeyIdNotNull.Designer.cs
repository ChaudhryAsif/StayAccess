...
namespace StayAccess.DAL.Migrations
{
    ...
    [Migration("20250129175819_UUIdAndKeyIdNotNull")]
    partial class UUIdAndKeyIdNotNull
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StayAccess.DAL.DomainEntities.LockKey", b =>
                {
                    ...
                    b.HasIndex("UUid", "BuildingId")
                        .IsUnique()
                        .HasFilter("[UUid] IS NOT NULL AND [BuildingId] IS NOT NULL");

                    b.HasIndex("UUid", "BuildingUnitId")
                        .IsUnique()
                        .HasFilter("[UUid] IS NOT NULL AND [BuildingUnitId] IS NOT NULL");
