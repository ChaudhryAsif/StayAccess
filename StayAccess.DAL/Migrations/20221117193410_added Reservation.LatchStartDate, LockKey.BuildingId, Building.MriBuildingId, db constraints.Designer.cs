...
namespace StayAccess.DAL.Migrations
{
    ...
    [Migration("20221117193410_added Reservation.LatchStartDate, LockKey.BuildingId, Building.MriBuildingId, db constraints")]
    partial class addedReservationLatchStartDateLockKeyBuildingIdBuildingMriBuildingIddbconstraints
    {
            ...
            modelBuilder.Entity("StayAccess.DAL.DomainEntities.LockKey", b =>
                {
                    ...
                    b.HasCheckConstraint("CK_LockKey_BuildingUnitId_or_BuildingId_Is_Null_And_Not_Both_Null", "([BuildingUnitId] IS NULL OR [BuildingId] IS NULL) AND NOT ([BuildingUnitId] IS NULL AND [BuildingId] IS NULL)");
                });
            ...
            modelBuilder.Entity("StayAccess.DAL.DomainEntities.Reservation", b =>
                {
                    ...
                    b.Property<DateTime?>("LatchStartDate")
                        .HasColumnType("datetime2");
